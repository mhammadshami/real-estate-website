    ...
    <section>
      <div className="container mx-auto min-h-[800px] mb-14">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div>
            <h2 className="text-2xl font-semibold ">{house[0]?.name}</h2>
            <h3 className="text-lg mb-4 ">{house[0]?.address}</h3>
          </div>
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row ">
          <div className="max-w-[768px]">
            <div className="mb-8 ">
              <img src={house[0].imageLg} alt="" />
            </div>
            <div className="flex gap-x-6 text-violet-700 mb-6 ">
              <div className="flex gap-x-2 items-center ">
                <BiBed className="text-2xl " />
                <div>{house[0].bedrooms}</div>
              </div>
              <div className="flex gap-x-2 items-center ">
                <BiBath className="text-2xl " />
                <div>{house[0].bathrooms}</div>
              </div>
              <div className="flex gap-x-2 items-center ">
                <BiArea className="text-2xl " />
                <div>{house[0].surface}</div>
              </div>
            </div>
            <div>{house[0].description}</div>
          </div>
          <div className="flex-1 bg-white border-gray-300 rounded-lg w-full mb-8 border px-6 py-8 ">
            <div className="flex items-center gap-x-4 mb-8 ">
              <div className="w-20 h-20 p-1 border border-gray-300 rounded-full ">
                <img src={house[0].agent.image} alt="" />
              </div>
              <div>
                <div className="font-bold text-lg ">{house[0].agent.name}</div>
